...
class AutoEncoder(object):
    ...
    def __init__(self):
        ...
        self.conv1_f2 = op.Encoder(128, 128, 3, 3, name='encoder1_flat1')
        ...
        self.conv3_f3 = op.Encoder(512, 512, 3, 3, name='encoder3_flat3')
        ...
        self.deconv3 = op.PixelShuffler(op.Encoder(512, 1024, 3, 3, name='decoder3'), 256, 2)
        self.deconv3_f1 = op.Encoder(256, 128, 3, 3, name='decoder3_flat1')
        self.deconv3_res = op.ResNet(128, name='decoder3_res')
        self.deconv2 = op.PixelShuffler(op.Encoder(128, 512, 3, 3, name='decoder2'), 128, 2)
        self.deconv2_f1 = op.Encoder(128, 64, 3, 3, name='decoder2_flat1')
        self.deconv2_res = op.ResNet(64, name='decoder2_res')
        ...
        self.deconv1_res = op.ResNet(32, name='decoder1_res')
