...
class AutoEncoder(object):
    ...
    def __init__(self):
        ...
        self.conv3_f4 = op.Encoder(1024, 512, 3, 3, name='encoder3_flat4')
        ...
        self.deconv2_f2 = op.Encoder(64, 64, 3, 3, name='decoder2_flat2')
        ...
        self.deconv0 = op.Encoder(32, 3, 3, 1, name='decoder0')
...
def autoencoder(images, scale=1.0):
    ...
    net = relu(AE.bnc3_f4(AE.conv3_f4(net)))
