    ...
    with tf.Session(
        ...
        class LoggingSession(object):
            ...
            def save_checkpoint(self):
                self.saver.save(self.sess, self.train_dir)

            def save_summary(self):
                summary = self.sess.run(self.merged_summaries)
                self.summary_writer.add_summary(summary, tf.train.get_global_step())
            ...
            def run(self):
                ...
                for i in range(self.max_steps):
                    ...
                    if duration > self.save_checkpoint_per_sec:
                        self.save_checkpoint()
